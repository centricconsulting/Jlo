        ...
        try {
            ...
            if (tranType == "salesorder") {
                ...
                if (!eTailOrderID) {
                    ...
                    if (shopify_Original_Order_ID) {
                        SORecord.setValue({ fieldId: 'custbody_celigo_etail_order_id', value: shopify_Original_Order_ID });
                    }
                ...
                if (!eTailOrderID) {
                    ...
                    if (createdForm) {
                        var soFlds = search.lookupFields({
                            ...
                            id: createdForm,
                            columns: ["custbody_celigo_etail_order_id"],
                        });
                        shopify_Original_Order_ID = soFlds.custbody_celigo_etail_order_id;
                    }
                    if (shopify_Original_Order_ID) {
                        invRecord.setValue({ fieldId: 'custbody_celigo_etail_order_id', value: shopify_Original_Order_ID });
                    }
